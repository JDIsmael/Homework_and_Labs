...
public class Tax_Calculation {
    ...
    /* [DefineInTable] verifica que la base imponible se encuentra entre sus rangos
     * devolvera una variable de tipo ArrayList<Integer>.
     * en su posicion 0 se guardara el impuesto fraccion basica
     * posicion 1 se guardara el porcentaje del impuesto fracion basica
     * posicion 2 se guardara la fraccion basica
     * Nota: si el taxBase es menor al LimitFractionTax devolvera un array de 
     * dos posiciones las cuales solo tendran 0 
     */
