...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu2.setText("ServiTech");
        jMenu2.setFocusTraversalKeysEnabled(false);
        jMenu2.setFocusable(false);

        jMenu5.setText("A cerca de...");

        jMenuItem5.setText("My system");
        jMenu5.add(jMenuItem5);

        jMenuItem6.setText("My license");
        jMenu5.add(jMenuItem6);

        jMenuItem7.setText("My Copyright");
