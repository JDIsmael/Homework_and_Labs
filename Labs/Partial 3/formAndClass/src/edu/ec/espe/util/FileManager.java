...
public class FileManager 
{
     ...
     * @param name 
     */
    public static ArrayList<String> readFile (File name,boolean check){
        ...
        try{
            ...
            if(!check){
                ...
                {
                    linea.add(entrada.nextLine());
                }
                read.close();
            }else{
                int i =0;
                do{
                    linea.add(reader.readLine());
                    i++;
                }while(linea.get(i-1) != null);
                linea.remove(linea.size());
            reader.close();
